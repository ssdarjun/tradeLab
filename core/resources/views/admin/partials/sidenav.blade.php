        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.crypto.currency.index')}}">
                    <a href="{{route('admin.crypto.currency.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.crypto.currency.index') }}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.trade.log*',3)}}">
                        ...
                        <span class="menu-title">@lang('Trade log')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.trade.log*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.trade.log.index')}} ">
                                <a href="{{route('admin.trade.log.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.trade.log.wining')}} ">
                                <a href="{{route('admin.trade.log.wining')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Wining')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.trade.log.losing')}} ">
                                <a href="{{route('admin.trade.log.losing')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Losing')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.trade.log.draw')}} ">
                                <a href="{{route('admin.trade.log.draw')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.practice.trade.log*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.practice.trade.log.index')}} ">
                                <a href="{{route('admin.practice.trade.log.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.practice.trade.log.wining')}} ">
                                <a href="{{route('admin.practice.trade.log.wining')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Wining')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.practice.trade.log.losing')}} ">
                                <a href="{{route('admin.practice.trade.log.losing')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Losing')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.practice.trade.log.draw')}} ">
                                <a href="{{route('admin.practice.trade.log.draw')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Draw')</span>
                                </a>
                            </li>
